...
open class BaseApplicationDelegate: UIResponder, UIApplicationDelegate {

    public var window: UIWindow?

    open var services: [ApplicationService] { return [] }
    private lazy var listServices: [ApplicationService] = {
    ...
    open func applicationDidFinishLaunching(_ application: UIApplication) {
        listServices.forEach { $0.applicationDidFinishLaunching?(application) }
    }
...
//    }
    ...
    // Called when the user activates your application by selecting a shortcut on the searchTickets screen,
